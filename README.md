...
This repository demonstrates the core pieces of an inference service: model lifecycle management,
real-time and batch prediction APIs, request validation, latency metrics, health checks, Docker
packaging, and tests.
